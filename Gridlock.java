...
public class Gridlock extends SimState
{
    ...
    // the numbers relate to figures in the ID_ID columns of the .CSV and the FNODE and TNODE
    // columns in the roads.shp files, I think
    // NOT ALL ID_IDs ARE IN .CSV. There are more in the roads.shp than in the .CSV.
    Integer[] goals =
    {
